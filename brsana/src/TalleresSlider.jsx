      ...
      <div className="card-wrapper"> 
        <div className="card-list swiper-wrapper">
          ...
          <div className="swiper-slide">
            ...
            img3src={"./src/assets/brunch 2.jpeg"}
          ...
          <div className="swiper-slide">
            ...
            img1src={"./src/assets/yoga4.jpeg"}
            img2src={"./src/assets/yoga-y-foto.jpeg"}
            img3src={"./src/assets/brunch 4.jpeg"}
          ...
          <div className="swiper-slide">
            ...
            img1src={"./src/assets/yoga5.jpeg"}
            img2src={"./src/assets/aromaterapia.jpeg"}
            img3src={"./src/assets/brunch 3.jpeg"}
          ...
          <div className="swiper-slide">
            ...
            img1src={"./src/assets/yoga6.jpeg"}
            img2src={"./src/assets/zentangle.jpeg"}
            img3src={"./src/assets/brunch 1.jpeg"}
            ...
            img1src={"./src/assets/yoga7.jpeg"}
            img2src={"./src/assets/sahumos.jpeg"}
            img3src={"./src/assets/brunch 5.jpeg"}
