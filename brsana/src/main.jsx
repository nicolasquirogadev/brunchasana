    ...
    <section id='equipo'>
      ...
      <div className="equi-box">
        ...
        <div className="equi-container">
          <div className="eq-img-container one"><img src="./src/assets/yoga4.jpeg" alt="" /></div>
          <div className="eq-img-container two"><img src="./src/assets/brunchage.jpeg" alt="" /></div>
          <div className="eq-img-container thr"><img src="./src/assets/yoga3.jpeg" alt="" /></div>
        </div>
